...
public class DepartementController {
    ...
    public String listeDepartement(ModelMap modelMap,
            ...
            Page<Departement> depa = departementServices.getAllDepartementParPage(page, size);
            modelMap.addAttribute("Departement", depa); 
...
//    }
    ...
    public String updateDepartement(@ModelAttribute("Departement") Departement departement, @RequestParam("date") String date, ModelMap modelMap) throws ParseException {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        Date dateAffectation = dateFormat.parse(date);
        departement.setDateAffectation(dateAffectation);
        departementServices.updateDepartement(departement);
        // Récupérer la liste mise à jour de départements
        List<Departement> depa = departementServices.getAllDepartement();
